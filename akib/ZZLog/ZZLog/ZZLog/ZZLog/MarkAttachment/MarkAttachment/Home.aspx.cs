...
namespace BackOfficeUI
{
    public partial class Home : BasePage
    {
        ...
        protected void btnMarkAttachment_Click(object sender, EventArgs e)
        {
            ...
            lblErr.Text = "Marked Successfully";
        ...
        private void SetData(DataTable dt)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                {
                    html.Append("<tr  >");
                    html.Append("<td  style='text-align:left;font-size:11pt;padding-left:5px;'   >" + row["OC_ATTACHMENTS_MISSING_LOG_ID"] + "</td>");
        ...
        {
            var text = txtUnmark.Text;
            controller.runUnMarkAttachmentProcedure(text, _sConn);
            lblErr.Text = "Unmarked Successfully";
            lblErr.ForeColor = System.Drawing.Color.Green;
            errPanel.Visible = true;
            DataTable dt = controller.GetMarkedAttachments(_sConn, txtSearch.Text);
            SetData(dt);
